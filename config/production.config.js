module.exports = {
  env: {
    //server upload
    NEXT_PUBLIC_API_UPLOAD: 'https://static.payme.vn',
    NEXT_PUBLIC_API_URL_IDMC: 'https://idmc.payme.vn',
    // config gapi
    NEXT_PUBLIC_GAPI_GRAPHQL_URL: 'https://gapi.payme.vn',
    NEXT_PUBLIC_GAPI_GRAPHQL_URL_PRODUCTION: 'https://gapi.payme.vn',
    NEXT_PUBLIC_GAPI_GRAPHQL_URL_WS: 'wss://gapi.payme.vn',

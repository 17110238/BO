module.exports = {
  env: {
    ...
    NEXT_PUBLIC_API_URL_IDMC: 'http://sbx-idmc.payme.vn',
    // config gapi
    NEXT_PUBLIC_GAPI_GRAPHQL_URL: 'https://sbx-gapi.payme.vn',
    NEXT_PUBLIC_GAPI_GRAPHQL_URL_PRODUCTION: 'https://sbx-gapi.payme.vn',
    NEXT_PUBLIC_GAPI_GRAPHQL_URL_WS: 'wss://sbx-gapi.payme.vn',

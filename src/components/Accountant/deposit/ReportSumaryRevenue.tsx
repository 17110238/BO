import { AccountantCrossCheckFormat, SumRevenueReport ,AccountantCrossCheck} from 'models';
...
data?.map((item)=>{
  numberDespositAmount=numberDespositAmount + item?.amountCrossCheck
  ...
  return (
    <div className='revenue-accountant__summary-revenue mt-3'>
      <div className='summary-revenue__layout' style={{backgroundColor:'#fff',marginRight:'0px'}}>

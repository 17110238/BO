...
const SalaryAdvanceReportHeader: FC<Props> = ({ isShowFilter, isClickFilter }) => {
  const { t } = useTranslation('common');
  return (
    <div className='linkedbank-header-container'>
      <p className='linkedbank-header__title'>Báo cáo ứng lương</p>
...
export default SalaryAdvanceReportHeader;

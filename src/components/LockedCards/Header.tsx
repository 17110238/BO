...
const Header: React.FC<HeaderProps> = ({ showFilter, toggleFilter, t }) => {
  return (
    <div className='header-locked-cards-container'>
      <p className='header-locked-cards__title'>{t('Quản lý các thẻ ATM VISA đã khóa')}</p>
      <div className='header-locked-cards__btn-group'>
        <button

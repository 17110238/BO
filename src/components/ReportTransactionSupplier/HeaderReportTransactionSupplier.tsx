...
const HeaderReportSupplier = ({ showFilter, toggleFilter }: Props) => {
    
    return (
      <div className='header-container'>
        <div className='header__title'>{'Thống kê giao dịch nhà cung cấp'}</div>
...
export default HeaderReportSupplier
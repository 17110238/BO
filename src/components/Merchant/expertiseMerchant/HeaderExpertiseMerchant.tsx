...
const HeaderExpertiseMerchantContainer: React.FC<Prop> = ({
  isShowFilter,
  onClickFilter,
  onClickExport,
}) => {
  ...
  return (
    <>
      <div className='header-merchant-container'>
        <p className='header-merchant__title'>{t('Thẩm định')}</p>
        <div className='header-merchant__btn-group'>
          <button
            className={`filter-btn btn ${isShowFilter ? 'btn-active ' : 'mx-0'}`}
...
export default HeaderExpertiseMerchantContainer;

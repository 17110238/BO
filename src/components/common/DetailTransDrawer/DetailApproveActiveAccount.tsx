...
import { GetAccountActiveInfoResponsed, MerchantState } from 'models';
import React, { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { getAccountActiveInfo } from 'redux/actions';
...
const DetailApproveActiveMerchant: React.FC<DetailTransDrawerProps> = ({
  ...
  const [changedInfoList, setChangedInfoList] = useState<GetAccountActiveInfoResponsed>();
  ...
  useEffect(() => {
    ...
    dispatch(
      getAccountActiveInfo(payload, (status, res) => {
        if (status) {
        ...
        {changedInfoList
          ...
          <>
            ...
            <div className='row-custom'>
              ...
              <div className='col-right text-right'>
                {changedInfoList?.accountId}
              </div>
            </div>
            <div className='row-custom'>
              <div className='col-left'>Username:</div>
              <div className='col-right text-right'>
                {changedInfoList?.username}
              </div>
            </div>
            <div className='row-custom'>

...
const ReportWalletServiceHeader: FC<Props> = ({ isShowFilter, isClickFilter }) => {
  const { t } = useTranslation('common');
  return (
    <div className='linkedbank-header-container'>
      <p className='linkedbank-header__title'>Thống kê các dịch vụ ví</p>
      <div className='linkedbank-header__filter'>
        <button
          className={`filter-btn btn ${isShowFilter ? 'btn-active' : ''}`}
          onClick={isClickFilter}>
          <svg
            width='14'
            height='12'
...
export default ReportWalletServiceHeader;

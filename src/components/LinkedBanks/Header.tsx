...
const LinkedBanksHeader: FC<Props> = ({ isShowFilter, isClickFilter }) => {
  const { t } = useTranslation('common');
  return (
    <div className='linkedbank-header-container'>
      <p className='linkedbank-header__title'>Quản lý liên kết ngân hàng</p>
...
export default LinkedBanksHeader;

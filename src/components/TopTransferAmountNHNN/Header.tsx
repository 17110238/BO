...
const EwalletReportHeader: FC<Props> = ({ showFilter, toggleFilter }) => {
  const { t } = useTranslation('common');

  return (
    <div className='linkedbank-header-container'>
      <p className='linkedbank-header__title'>Danh sách 10 ví có SLGD nhiều nhất</p>
...
export default EwalletReportHeader;

...
const HeaderScope: React.FC<Prop> = ({
  isShowFilter,
  onShowFilter,
  onClickExport,
  showCreateModal,
  ...
  return (
    <div className='linkedbank-header-container'>
      <p className='linkedbank-header__title'>{t('Quản lý Scope')}</p>
      <div className='linkedbank-header__filter'>
        <button
          ...
          {t(['Lọc', 'Ẩn lọc'][+(isShowFilter || 0)])}
        </button>
        <button className='btn btn-secondary btn-search' onClick={showCreateModal}>

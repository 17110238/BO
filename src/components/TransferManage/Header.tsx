...
interface HeaderTransferProps {
  showFilter?: boolean;
  toggleFilter?: () => void;
  t: (a: string) => string;
}

const HeaderTransfer: React.FC<HeaderTransferProps> = ({ showFilter, toggleFilter, t }) => {
  return (
    <div className='header-transfer-manage-container'>
      <p className='header-transfer__title'>{t('Quản lý chuyển khoản')}</p>
      <div className='header-transfer__btn-group'>
        <button

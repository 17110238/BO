...
const TopTransferHeader: FC<Props> = ({ isShowFilter, isClickFilter, isShowFilterBtn, title }) => {
  const { t } = useTranslation('common');
  return (
    <div className='linkedbank-header-container'>
      <p className='linkedbank-header__title'>{title}</p>
      {isShowFilterBtn && (
...
export default TopTransferHeader;

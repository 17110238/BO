...
const Header: React.FC<Props> = ({ showFilter, toggleFilter, t }) => {
  return (
    <div className='header-user-statistics-container'>
      <p className='header-user-statistics__title'>{t('Thống kê người dùng')}</p>
      <div className='header-user-statistics__btn-group d-flex align-items-center'>
        <button

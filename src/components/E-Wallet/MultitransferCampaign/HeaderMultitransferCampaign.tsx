...
const HeaderMultitransferCampaign: React.FC<HeaderMultitransferCampaignProps> = ({
  ...
  return (
    <div className='header-multitransfer-campaign-container'>
      <p className='header-multitransfer-campaign__title'>{t('Lịch sử chuyển theo danh sách')}</p>
      <div className='header-multitransfer-campaign__btn-group'>
        ...
        <button 
          className='btn manage-staff-btn ml-3'
          onClick={() => router.push('/payme/multitransfer-campaign/member')}
        >

...
interface HeaderStaffManageProps {
  showFilter?: boolean;
  toggleFilter?: () => void;
  onOpenAddStaff: () => void;
}

const HeaderStaffManage: React.FC<HeaderStaffManageProps> = ({
  showFilter,
  toggleFilter,
  onOpenAddStaff
}) => {
  ...
  return (
    <div className='header-multitransfer-campaign-container'>
      <div className='header-multitransfer-campaign__title d-flex align-items-center'>
        <OverlayTrigger
          placement="bottom"
...
export default HeaderStaffManage;

...
const Header: React.FC<Props> = ({
  ...
  return (
    <div className='header-manual-bank-deposit-container'>
      <AddTransaction
        t={t}
        show={showModal}
      ...
      />
      <p className='header-manual-bank-deposit__title'>{t('Gửi tiền bằng Ngân hàng Thủ công')}</p>
      <div className='header-manual-bank-deposit__btn-group'>
        <div className='d-flex align-items-center mr-3 btn-deposit'>
          <button
            ...
            {t('Add Bank Transfer Transaction')}
          </button>
        </div>

...
import { BIDVTransactionObject } from 'models';
...
export default function BIDVTable({ t, data, getDataList, isLoading, ...rest }: Props) {
  const lang = localStorage.getItem('NEXT_LOCALE');

  const columns: TableColumn<BIDVTransactionObject>[] = useMemo(
    () => [
      {
        name: t('Mã GD'),
        minWidth: '125px',

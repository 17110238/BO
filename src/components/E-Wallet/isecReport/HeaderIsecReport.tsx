...
const HeaderIsecReportManager: React.FC<Prop> = ({ isShowFilter, onClickFilter, onClickExport }) => {
  const { t } = useTranslation('common');
  return (
    <>
      <div className='header-approval-merchant-container'>
        <p className='header-approval-merchant__title'>{t('Báo cáo Isec theo tài khoản')}</p>
...
export default HeaderIsecReportManager;

...
interface HeaderMerchantInfoProps {
  showFilter?: boolean;
  toggleFilter?: () => void;
  t: (a: string) => string;
...
const HeaderMerchantInfo: React.FC<HeaderMerchantInfoProps> = ({
  showFilter,
  toggleFilter,
  t,
}) => {
  return (
    <div className='header-merchant-info-container'>
      <p className='header-merchant-info__title'>{t('Thông tin khách hàng')}</p>
      <div className='header-merchant-info__btn-group'>
        <button
...
export default HeaderMerchantInfo;

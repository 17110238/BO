...
const HeaderIsecManager: React.FC<Prop> = ({ isShowFilter, onClickFilter, onClickExport }) => {
  const { t } = useTranslation('common');
  return (
    <>
      <div className='header-approval-merchant-container'>
        <p className='header-approval-merchant__title'>{t('')}</p>
...
export default HeaderIsecManager;

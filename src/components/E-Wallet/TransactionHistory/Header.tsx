...
const Header: React.FC<Props> = ({ showFilter, toggleFilter, t }) => {
  return (
    <div className='header-transaction-history-container'>
      <p className='header-transaction-history__title'>{t('Transaction history')}</p>
      <div className='header-transaction-history__btn-group'>
        <button

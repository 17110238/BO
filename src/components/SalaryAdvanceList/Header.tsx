...
const SalaryAdvanceListHeader: FC<Props> = ({ isShowFilter, isClickFilter }) => {
  const { t } = useTranslation('common');
  return (
    <div className='linkedbank-header-container'>
      <p className='linkedbank-header__title'>Danh sách ứng lương</p>
...
export default SalaryAdvanceListHeader;

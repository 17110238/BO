...
export default function HeaderReportTransaction({ showFilter,
  toggleFilter,}:HeaderAccountantProps) {
  const { t } = useTranslation('common');
  return (
    <div className='reportTransaction-header'>
      <div className='reportTransaction-header__content'>
        <div className='reportTransaction-header__title'>
          <h2>{t('Báo cáo thu hộ chi hộ ')}</h2>
        </div>
        <div className='reportTransaction-header__filter' style={{ height: '44px' }}>
        <button

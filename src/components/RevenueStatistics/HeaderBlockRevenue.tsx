...
const HeaderBlockRevenue: React.FC<Prop> = ({ isShowFilter, onClickFilter, onClickExport }) => {
  const { t } = useTranslation('common');
  return (
    <>
      <div className='header-approval-merchant-container revenue-statistics__header-block'>
        <p className='header-approval-merchant__title'>{t('Thống kê doanh thu')}</p>
...
export default HeaderBlockRevenue;
